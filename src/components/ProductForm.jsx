...
//         <input
//           id="name"
//           className={`${isMobile ? "mt-1" : "col-span-3"} rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500`}
//           value={newProduct?.name || ""}
...
//                   className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
//                   onClick={() => {
//                     setNewProduct({ ...newProduct, unit: "kg" })
//                     setUnitDropdownOpen(false)
//                   }}
//                 >
//                   Kilogram (kg)
...
//                   className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
//                   onClick={() => {
//                     setNewProduct({ ...newProduct, unit: "grams" })
//                     setUnitDropdownOpen(false)
//                   }}
//                 >
//                   Grams (g)
...
//                   className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100"
//                   onClick={() => {
//                     setNewProduct({ ...newProduct, unit: "count" })
//                     setUnitDropdownOpen(false)
//                   }}
//                 >
//                   Count/Number
